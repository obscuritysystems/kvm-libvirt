...
then 
	...
	virt-install  -n $1 -r $2 --os-type=linux --os-variant=rhel6 --disk $IMAGE_PATH$1.qcow2  --location  http://mirrors.xmission.com/ubuntu/dists/quantal/main/installer-amd64/ -x "console=ttyS0" --hvm --accelerate --network bridge=br0,mac=$MAC --vnc                                                      
else 
