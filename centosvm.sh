...
then 
	...
	virt-install  -n $1 -r $2 --os-type=linux --os-variant=rhel6 --disk $IMAGE_PATH$1.qcow2  --location /opt/CentOS-5.9-x86_64-bin-1of9.iso -x "console=ttyS0" --hvm --accelerate --network bridge=virbr0,mac=$MAC --vnc                                                      
else 
